...
const Hero = () => {
  return (
    <div className='p-10 flex flex-col items-center justify-center mt-24 md:px-20 lg:px-36 xl:px-48'>
        ...
        <p className='text-gray-500 mt-4 text-center text-2xl'>Create engaging, AI-generated YouTube Shorts with ease—perfect for content creators, marketers, and influencers.</p>
